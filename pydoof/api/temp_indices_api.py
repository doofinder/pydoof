...
class TempIndicesApi(object):
    ...
    def reindex_to_temp_with_http_info(self, hashid, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/search_engines/{hashid}/datatypes/{name}/reindex_to_temp/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_by_temp_with_http_info(self, hashid, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/search_engines/{hashid}/datatypes/{name}/replace_by_temp/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
